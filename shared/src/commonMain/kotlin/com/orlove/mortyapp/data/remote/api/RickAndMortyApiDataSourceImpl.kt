...
import com.orlove.mortyapp.utils.constants.api.CHARACTER_GENDER_PARAMETER
import com.orlove.mortyapp.utils.constants.api.CHARACTER_NAME_PARAMETER
import com.orlove.mortyapp.utils.constants.api.CHARACTER_PAGE_PARAMETER
import com.orlove.mortyapp.utils.constants.api.CHARACTER_STATUS_PARAMETER
    ...
    override suspend fun getCharacters(
        ...
        return try {
            val response = client.get(CHARACTER_ENDPOINT) {
                ...
                parameter(CHARACTER_NAME_PARAMETER, name)
                if (gender != null) {
                    parameter(CHARACTER_GENDER_PARAMETER, gender)
                }
                if (status != null) {
                    parameter(CHARACTER_STATUS_PARAMETER, status)
                }
